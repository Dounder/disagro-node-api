...
CREATE TABLE "attendance" (
    ...
    "services_total" DECIMAL(20,4) NOT NULL,
    "services_discount" DECIMAL(10,4) NOT NULL,
    "products_total" DECIMAL(20,4) NOT NULL,
    "products_discount" DECIMAL(10,4) NOT NULL,
